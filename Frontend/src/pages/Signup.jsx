...
import { FiUser, FiMail, FiPhone, FiLock, FiCheck, FiHome } from 'react-icons/fi';
  ...
  return (
    <div className="h-auto bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md items-center text-center">
        ...
        <h3 className="text-2xl font-semibold text-gray-600 mt-2">Create your account</h3>
        ...
        <div className="bg-white py-8 px-6 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-5">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none mt-5">
                  <FiUser className="h-5 w-5 mt-[-1.4rem] text-gray-400" />
                </div>
                <input
                  id="name"
                  name="name"
            ...
            <div className="relative">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none mt-5">
                  <FiPhone className="h-5 w-5 mt-[-1.4rem] text-gray-400" />
                </div>
                <input
                  id="phone"
                  name="phone"
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
              >
                Sign up
              </button>
            </div>
